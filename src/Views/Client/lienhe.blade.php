<section class="lienhe"> 
    <section>
        ...
        <p>Cửa hàng 2: 63 Đông Các, Đống Đa, Hà Nội</p>
        <p>Điện thoại: 039.913.1006</p>
        <p>Email: caraclothes@gmail.com</p>
    </section>
    <section>
        <h2>Thông tin liên hệ</h2>
        <form>
            <section class="form-group mb10">
            ...
            <section class="form-group mb10">
                ...
                <textarea class="form-control" rows="5" placeholder="Nhập tin nhắn của bạn"></textarea>
            </section><br>
            <button type="submit">Gửi</button>
        </form>
    </section>
</section>
<section class="bando mb">
    <h2>Bản đồ</h2>
    <section>
